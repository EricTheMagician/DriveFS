...
namespace DriveFS::FileManager{
    ...
    extern PriorityCache<GDriveObject> DownloadCache;
    ...
    extern GDriveObject fromParentIdAndName(std::string const &id, char const* name);
    ...
    extern void insertObjectToMemoryMap(const GDriveObject &object);
